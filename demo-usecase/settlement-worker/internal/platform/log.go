...
// applicable. The environment is not among them: the platform labels every line with the
// environment it collected it from, and a value the service asserts about itself is a
